...
extension MySQLPacketDescriptions {
    ...
    struct HandshakeResponse41 {
        ...
        ///
        /// It is not possible to reliably distinguish a handshake response packet from other packets; thus,
        /// any problem with decoding is always considered a protocol violation.
        ///
        /// The capability flags provided are assumed to be the server's supported flags, pre-negotiation.
        ///
        /// - Throws: Protocol violation error for a `HandshakeRequest41` packet with invalid or truncated data
        ...
        ///
        /// > Note: The `capabilities` parameter is ignored; the packet is built from the capabilityFlags properties.
