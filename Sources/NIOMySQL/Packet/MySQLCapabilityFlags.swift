...
public struct MySQLCapabilityFlags: OptionSet, CustomStringConvertible {
    /// Use the improved version of Old Password Authentication.
    /// note: Assumed to be set since 4.1.1.
    public static let CLIENT_LONG_PASSWORD = MySQLCapabilityFlags(rawValue: 0x00000001)
    
    /// Send found rows instead of affected rows in EOF_Packet.
    public static let CLIENT_FOUND_ROWS = MySQLCapabilityFlags(rawValue: 0x00000002)
    
    /// Longer flags in Protocol::ColumnDefinition320.
    /// Server: Supports longer flags.
    /// Client: Expects longer flags.
    public static let CLIENT_LONG_FLAG = MySQLCapabilityFlags(rawValue: 0x00000004)
    ...
    public static let CLIENT_CONNECT_WITH_DB = MySQLCapabilityFlags(rawValue: 0x00000008)
    
    /// Server: Do not permit database.table.column.
    public static let CLIENT_NO_SCHEMA = MySQLCapabilityFlags(rawValue: 0x00000010)
    
    /// Compression protocol supported.
    /// Server: Supports compression.
    /// Client: Switches to Compression compressed protocol after successful authentication.
    public static let CLIENT_COMPRESS = MySQLCapabilityFlags(rawValue: 0x00000020)
    
    /// Special handling of ODBC behavior.
    /// note: No special behavior since 3.22.
    public static let CLIENT_ODBC = MySQLCapabilityFlags(rawValue: 0x00000040)
    
    /// Can use LOAD DATA LOCAL.
    /// Server: Enables the LOCAL INFILE request of LOAD DATA|XML.
    /// Client: Will handle LOCAL INFILE request.
    public static let CLIENT_LOCAL_FILES = MySQLCapabilityFlags(rawValue: 0x00000080)
    
    /// Server: Parser can ignore spaces before '('.
    /// Client: Let the parser ignore spaces before '('.
    public static let CLIENT_IGNORE_SPACE = MySQLCapabilityFlags(rawValue: 0x00000100)
    
    /// Server: Supports the 4.1 protocol.
    /// Client: Uses the 4.1 protocol.
    /// note: this value was CLIENT_CHANGE_USER in 3.22, unused in 4.0
    public static let CLIENT_PROTOCOL_41 = MySQLCapabilityFlags(rawValue: 0x00000200)
    ...
    public static let CLIENT_INTERACTIVE = MySQLCapabilityFlags(rawValue: 0x00000400)
    
    /// Server: Supports SSL.
    /// Client: Switch to SSL after sending the capability-flags.
    public static let CLIENT_SSL = MySQLCapabilityFlags(rawValue: 0x00000800)
    
    /// Client: Do not issue SIGPIPE if network failures occur (libmysqlclient only).
    /// See mysql_real_connect()
    public static let CLIENT_IGNORE_SIGPIPE = MySQLCapabilityFlags(rawValue: 0x00001000)
    ...
    public static let CLIENT_TRANSACTIONS = MySQLCapabilityFlags(rawValue: 0x00002000)
    
    /// Unused.
    /// note: Was named CLIENT_PROTOCOL_41 in 4.1.0.
    public static let CLIENT_RESERVED = MySQLCapabilityFlags(rawValue: 0x00004000)
    
    /// Server: Supports Authentication::Native41.
    /// Client: Supports Authentication::Native41.
    public static let CLIENT_SECURE_CONNECTION = MySQLCapabilityFlags(rawValue: 0x00008000)
    ...
    public static let CLIENT_MULTI_STATEMENTS = MySQLCapabilityFlags(rawValue: 0x00010000)
    
    /// Server: Can send multiple resultsets for COM_QUERY.
    /// Client: Can handle multiple resultsets for COM_QUERY.
    /// requires: CLIENT_PROTOCOL_41
    public static let CLIENT_MULTI_RESULTS = MySQLCapabilityFlags(rawValue: 0x00020000)
    
    /// Server: Can send multiple resultsets for COM_STMT_EXECUTE.
    /// Client: Can handle multiple resultsets for COM_STMT_EXECUTE.
    /// requires: CLIENT_PROTOCOL_41
    public static let CLIENT_PS_MULTI_RESULTS = MySQLCapabilityFlags(rawValue: 0x00040000)
    ...
    /// Requires: CLIENT_PROTOCOL_41
    public static let CLIENT_PLUGIN_AUTH = MySQLCapabilityFlags(rawValue: 0x00080000)
    ...
    public static let CLIENT_CONNECT_ATTRS = MySQLCapabilityFlags(rawValue: 0x00100000)
    ...
    public static let CLIENT_PLUGIN_AUTH_LENENC_CLIENT_DATA = MySQLCapabilityFlags(rawValue: 0x00200000)
    ...
    public static let CLIENT_CAN_HANDLE_EXPIRED_PASSWORDS = MySQLCapabilityFlags(rawValue: 0x00400000)
    ...
    public static let CLIENT_SESSION_TRACK = MySQLCapabilityFlags(rawValue: 0x00800000)
    ...
    public static let CLIENT_DEPRECATE_EOF = MySQLCapabilityFlags(rawValue: 0x01000000)
    ...
    public static let MARIADB_CLIENT_PROGRESS = MySQLCapabilityFlags(rawValue: 0x0100000000) // 1 << 32
    
    /// Permit COM_MULTI protocol.
    public static let MARIADB_CLIENT_COM_MULTI = MySQLCapabilityFlags(rawValue: 0x0200000000) // 1 << 33
    
    /// Permit bulk insert.
    public static let MARIADB_CLIENT_STMT_BULK_OPERATIONS = MySQLCapabilityFlags(rawValue: 0x0400000000) // 1 << 34
    ...
    /// All capabilities.
    public static let all: [MySQLCapabilityFlags] = [
    ...
    public var description: String {
        return MySQLCapabilityFlags.all
